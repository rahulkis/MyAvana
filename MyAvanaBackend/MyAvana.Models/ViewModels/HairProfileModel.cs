...
namespace MyAvana.Models.ViewModels
{
    ...
    public class HairProfileModel2
    {
        ...
        public BottomRightMobile BottomRight { get; set; }
        public CrownStrandMobile CrownStrand { get; set; }
        public List<RecommendedVideosModel> RecommendedVideos { get; set; }
        public List<StylistCustomerModel> RecommendedStylist { get; set; }
        public HairAnalyst HairAnalyst { get; set; }
    }
    ...
    public class RecommendedProductsStylingAlexaModel
    {
        public string Name { get; set; }
        public string BrandName { get; set; }
        public string ProductParentName { get; set; }
    ...
    public class ProductsTypesStylingAlexaModels
    {
        public List<ProductsStylingAlexaModels> Products { get; set; }
    }
    ...
    public class ProductsStylingAlexaModels
    {
        public string ImageName { get; set; }
        public string ProductLink { get; set; }
        public string BrandName { get; set; }
    ...
    public class HairProfileCustomerAlexaModel
    {
        public string plan { get; set; }
        public RecommendedProductsAlexa products { get; set; }
        public DateTime nextProductUseTime { get; set; }
    }
    public class RecommendedProductsAlexa
    {
        public List<ProductsTypesAlexaModels> RecommendedEssentialProducts { get; set; }
        public List<ProductsTypesStylingAlexaModels> RecommendedStylingProducts { get; set; }
    }
    public class RecommendedProductsCustomerAlexa
    {
        public List<ProductsTypesModels> ProductsTypes { get; set; }
    }
    ...
    public class ProductsTypesAlexaModels
    {
        public string ProductTypeName { get; set; }
        public List<ProductsModelsAlexa> Products { get; set; }
    }
    ...
    public class ProductsModelsAlexa
    {
        public string ImageName { get; set; }
        public string ProductLink { get; set; }
        public string BrandName { get; set; }
    ...
    public class QuestionaireModelParameters
    {
        public string Userid { get; set; }
        public bool? IsExist { get; set; }
        public int? QuestionAnswerCount { get; set; }
    ...
    public class DigitalAssessmentModelParameters
    {
        public string Userid { get; set; }      
        public Guid? PaymentId { get; set; }
        public int? HairProfileId { get; set; }
    ...
    public class CustomerAIResultModel
    {
        public string UserId { get; set; }
        public string AIResult { get; set; }
        public int? HairProfileId { get; set; }
